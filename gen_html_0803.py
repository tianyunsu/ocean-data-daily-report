# -*- coding: utf-8 -*-
"""自包含生成器：从 feishu_write_doc.py 提取 SECTIONS（bracket-counting，无需 requests）"""
...
SECTIONS = ast.literal_eval(content[start:end])
...
<body>
  <div class="header">
    ...
    <h1>海洋AI技术日报</h1>
    <div class="subtitle">报告日期：{today} | 来源：ICML / IJCAI / ECCV / Copernicus / IOC / Schmidt Ocean 等 | 自动生成</div>
    <div class="summary-bar">
      ...
      <div class="summary-chip">覆盖 AI · 数字孪生 · 可视化 · 数据质量 · 处理 · 共享 · 航次 · 数据中心 · 工具</div>
    </div>
  </div>
  <nav class="nav-bar">
{nav_links}  </nav>
