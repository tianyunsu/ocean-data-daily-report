...
# -*- coding: utf-8 -*-
"""
更新 feishu_write_doc.py 中的 SECTIONS 数据 (2026-03-27)
"""
import ast
import re

NEW_SECTIONS_CODE = r'''SECTIONS = [
    {
        "title": "一、海洋人工智能",
        ...
        "items": [
            ...
            },
            {
                ...
                "badge": "[论文]",
                "abstract": (
                    "Springer Nature 于2026年1月出版专著章节 EBA-AI: Ethics-Guided Bias-Aware AI for Efficient Underwater Image Enhancement and Coral Reef Monitoring，"
        ...
        "items": [
            ...
            },
            {
                ...
                "abstract": (
                    ...
                    "并在2025年联合国海洋大会上获得冯德莱恩主席盛赞为"不可思议的工具"。"
                ),
            ...
            },
            {
                ...
                "badge": "[平台]",
                "abstract": (
                    "Mercator Ocean International 维护的欧洲数字孪生海洋平台（The European Digital Twin Ocean）"
                    "持续向研究人员、政策制定者、企业和公民开放，"
        ...
        "items": [
            {
                ...
                "abstract": (
                    ...
                    "MyOcean Viewer 于2026年3月11日完成最新一次更新，持续迭代维护，"
            ...
            {
                "title": "4. AOOS Ocean Data Explorer：阿拉斯加海洋观测系统数据浏览器（NOAA研讨会介绍）",
                "badge": "[工具]",
                "abstract": (
        ...
        "items": [
            {
                ...
                "abstract": (
                    ...
                    "QARTOD 项目计划2022-2026路线图持续推进，是全球海洋实时数据质量管理的核心标准。"
                ),
        ...
        "items": [
            {
                ...
                "abstract": (
                    ...
                    "最新版本在 NaN 跳过聚合、滚动窗口计算（依赖 bottleneck 加速）、"
                    "云存储直接读取等方面持续优化，"
            ...
            {
                "title": "2. 高效可扩展 AI 驱动海洋状态估计（arXiv:2511.06041）：解决计算可扩展性双重瓶颈",
                "badge": "[论文]",
                "abstract": (
    ...
    },
    {
        ...
        "items": [
            {
                "title": "1. IODE 国际海洋数据信息交换：全球100+国家海洋数据中心网络4天前更新",
                "badge": "[平台]",
                "abstract": (
            ...
            {
                "title": "2. IOC-UNESCO 海洋数据信息页：信息服务持续更新（4天前更新）",
                "badge": "[平台]",
                "abstract": (
                    "UNESCO 政府间海洋学委员会（IOC）数据与信息专页于4天前（约2026年3月23日）更新，"
                    "集中展示 IODE 全球数据中心网络、OceanTeacher 培训平台、"
                    "海洋数据标准与互操作规范等最新进展。"
                    "IOC 战略计划2023-2029 中，海洋数据信息管理被列为支撑'我们需要的海洋科学'的核心能力，"
            ...
            {
                "title": "4. Copernicus Marine Service（CMEMS）：4天前持续更新，提供全球和区域海洋数据产品",
                "badge": "[服务]",
                "abstract": (
                    "Copernicus Marine Service 官网于 4 天前（约2026年3月23日）完成最新更新，"
                    "持续提供覆盖物理、生物地球化学、海冰等要素的全球和区域海洋数据产品，"
                    "包括实时观测、预报模型输出和再分析数据集。"
                    "2026年3月产品路线图涵盖 Sentinel-1C 数据集上线、原位数据库 WOA23 更新、"
                    "多个区域预报系统精度提升等重要内容，"
        ...
        "items": [
            {
                ...
                "abstract": (
                    ...
                    "新版本优化了 NaN 跳过统计、滚动聚合（bottleneck 加速）、"
                    "坐标系插值等关键功能，完善了 Dask 懒计算和云存储集成，"
            ...
            {
                "title": "3. Sentinel-3B OLCI 海洋颜色数据产品：NASA Earthdata 1天前更新",
                "badge": "[数据]",
                "abstract": (
            ...
            {
                "title": "4. QARTOD GitHub 开源实现：实时海洋质控算法代码库（physoce/qartod）",
                "badge": "[工具]",
                "abstract": (
...
if start_idx == -1:
    print('ERROR: 找不到 SECTIONS = [ 标记')
    exit(1)

# 从 SECTIONS 开始找结尾（最后一个 ']' 后跟换行+空行或文档逻辑结束）
# 精确找法：从 start_idx 开始，计数方括号层级
depth = 0
end_idx = start_idx
i = start_idx
while i < len(content):
...
if end_idx == start_idx:
    print('ERROR: 找不到 SECTIONS 结尾 ]')
    exit(1)

# 替换 SECTIONS 块
new_content = content[:start_idx] + NEW_SECTIONS_CODE + content[end_idx+1:]
