...
slide1.Shapes(1).TextFrame.TextRange.Text = "树立和践行正确政绩观" & vbCrLf & vbCrLf & "学习教育工作部署"
slide1.Shapes(1).TextFrame.TextRange.Font.Size = 48
slide1.Shapes(1).TextFrame.TextRange.Font.Bold = True

' Slide 2
Set slide2 = pres.Slides.Add(2, 2)
slide2.Shapes(1).TextFrame.TextRange.Text = "一、会议背景" & vbCrLf & vbCrLf & "自然资源部召开党组会议，深入学习贯彻习近平总书记关于树立和践行正确政绩观的重要论述和重要指示精神，传达学习中办印发的《关于在全党开展树立和践行正确政绩观学习教育的通知》和中央党的建设工作领导小组会议精神。" & vbCrLf & vbCrLf & "自然资源部第一海洋研究所召开党委（扩大）会议，动员部署全所开展树立和践行正确政绩观学习教育工作。"
slide2.Shapes(1).TextFrame.TextRange.Font.Size = 24
...
slide3.Shapes(1).TextFrame.TextRange.Font.Size = 24
...
slide4.Shapes(1).TextFrame.TextRange.Font.Size = 24
...
slide5.Shapes(1).TextFrame.TextRange.Font.Size = 24
...
slide6.Shapes(1).TextFrame.TextRange.Font.Size = 24
...
WScript.Echo "PPT created successfully!"
