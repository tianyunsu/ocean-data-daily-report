    ...
    },
    {
        ...
        "items": [
            ...
            },
            {
                ...
                'badge': '[航次]',
                'abstract': 'NOAA 海洋探索计划公布 2026 年美属萨摩亚测绘航次（EX2607）：9月23日至10月18日，Okeanos Explorer 自斐济苏瓦出发、终抵夏威夷檀香山，开展全天候多波束测绘作业，覆盖海床、水柱与次海床，重点补测美属萨摩亚周边海床测绘数据空白。该航次是 NOAA 2026 太平洋系列航次（EX2605库克群岛ROV、EX2606美属萨摩亚ROV）之后的测绘接续任务，数据将为区域海床管理提供支撑。',
