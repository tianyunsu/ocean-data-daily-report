...
<div class="header">
  ...
  <h1>海洋AI技术日报</h1>
  <div class="date-line">''' + TODAY_CN + ''' · 周二</div>
</div>
<div class="container">
...
<div class="footer">
  ...
  <p>Powered by WorkBuddy AI · 本期来源：arXiv、中科院海洋所、科学网、npj Ocean Sustainability、Ocean Science、Climate Dynamics、JGR: Oceans、CMEMS、PyPI、Parcels 官方博客、IODP-China、新华社</p>
</div>
</body>
</html>'''
