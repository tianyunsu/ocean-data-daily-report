...
SECTIONS = [
  ...
  {'title': '七、开放航次 / 船时共享', 'en': 'Open Cruises / Ship Time Sharing', 'items': [
    ...
    {'title': 'NOAA（2026-05-06）：NOAA授予2160万美元合同采购Chance LR30无人水面艇——支持新一代测绘船', 'badge': '近7天', 'abstract': 'NOAA宣布向Chance Maritime Technologies授予2160万美元合同，采购最多8套Chance LR30无人水面艇系统。该系统具备直接操控、半自主（碰撞规避+动态航迹跟踪）和全自主三种运行模式，将装备于NOAA新一代测绘船Surveyor和Navigator，用于海底测绘和渔业声学调查。此项投资标志着NOAA海洋测绘向无人化转型的重大战略举措。', 'source': 'NOAA / Seapower Magazine / AUVSI', 'url': 'https://seapowermagazine.org/noaa-awards-21-6m-for-uncrewed-systems-to-support-new-charting-and-mapping-vessels/', 'date': '2026-05-06'},
  ]},
