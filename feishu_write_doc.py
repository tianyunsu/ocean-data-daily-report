...
SECTIONS = [
  {'title': '一、海洋人工智能', 'en': 'Ocean AI / Marine Artificial Intelligence', 'items': [
    {'title': '中国科学院院士陈大可：AI为海洋基础理论研究开辟新路径', 'badge': '近7天', 'abstract': '陈大可院士在第五届中国海洋工程技术大会上发表主旨报告，指出人工智能虽不会简单替代海洋基础理论研究，但能通过提升信息获取能力、增强数据挖掘能力、改进经验参数化和模型表达，为海洋基础理论研究提供全新工具和路径。他强调AI与传统物理海洋学的深度融合是未来发展的关键方向，尤其在极端天气预测、深海过程理解和海洋生态模拟等领域具有巨大潜力。', 'source': '科学网', 'url': 'https://news.sciencenet.cn/htmlnews/2026/5/564140.shtm', 'date': '2026-05-03'},
    {'title': '浙江大学构建OCEANPILE海洋多模态语料库——首个大规模海洋AI基础数据集', 'badge': '近7天', 'abstract': '浙江大学联合海洋感知国家重点实验室发布OCEANPILE（arXiv:2605.00877），包含三大核心组件：OceanCorpus（50亿+词元、30万+PDF的五类海洋数据整合）、OceanInstruction（约14万条知识图谱引导的指令问答对）和OceanBenchmark（1469道多模态评测题）。基于该语料库微调的Qwen3-VL-8B（8B参数）在海洋科学视觉问答上以32.59分超越GPT-5（9.67分），证明高质量领域专属数据的价值。数据集已开源至Hugging Face和GitHub。', 'source': '腾讯新闻 / arXiv', 'url': 'https://news.qq.com/rain/a/20260511A043LE00', 'date': '2026-05-11'},
    {'title': '海洋机器人融资数亿元——具身智能商业化加速推进', 'badge': '近7天', 'abstract': '在第二十八届中国北京国际科技产业博览会（5月8-10日）上，多款前沿智能装备亮相，包括具身天工3.0、宇树科技人形机器人、"虎鲸"海洋机器人等。其中"虎鲸"海洋机器人展示了水下自主作业能力，标志着海洋智能装备从实验室走向产业化的关键一步。海洋机器人领域近期融资规模已达数亿元，反映资本市场对海洋AI装备赛道的持续看好。', 'source': '新浪财经', 'url': 'https://finance.sina.com.cn/roll/2026-05-09/doc-inhxhqpm3484620.shtml', 'date': '2026-05-09'},
  ]},
  ...
  {'title': '三、海洋可视化', 'en': 'Ocean Visualization', 'items': [
    {'title': 'Copernicus Marine Service（2026-04-27）：2026年4月全球海表温度创历史第二高——赤道太平洋首破4月纪录', 'badge': '近7天', 'abstract': 'Copernicus Marine Service发布分析显示，2026年4月全球平均海表温度达21.08度C，为有记录以来第二暖4月（仅次于2024年4月）。赤道太平洋4月均温达26.99度C，创4月历史新高；海洋热浪覆盖全球46%海域（第三高）。东北太平洋、东南太平洋均记录到创纪录海温。C3S季节性预测显示2026年下半年将过渡至厄尔尼诺条件。', 'source': 'Copernicus Marine Service / Mercator Ocean International', 'url': 'https://marine.copernicus.eu/press/press-releases/april-2026-set-be-second-warmest-april-record-ocean-equatorial-pacific-hits', 'date': '2026-04-27'},
    {'title': 'Marine Cadastre Hub（2026-05-01）：美国海洋地籍Hub平台更新——支持多格式数据下载与API服务', 'badge': '近7天', 'abstract': '美国海洋地籍数据平台Marine Cadastre Hub持续更新，提供海洋空间规划所需的权威数据集，支持CSV、KML、GeoJSON、GeoTIFF、PNG等多种格式下载，以及GeoServices、WMS和WFS API接口。平台整合了海底地形、海域使用权、海洋保护区、人工鱼礁等多类数据图层，是海洋空间规划领域的重要数据可视化与分析工具。', 'source': 'NOAA / BOEM', 'url': 'https://hub.marinecadastre.gov/', 'date': '2026-05-01'},
  ]},
  ...
  {'title': '七、开放航次 / 船时共享', 'en': 'Open Cruises / Ship Time Sharing', 'items': [
    ...
    {'title': 'NOAA Ocean Exploration（2026-05-07）：E/V Nautilus 2026太平洋深海探索航季启动——6-10月中西部太平洋深海栖息地调查', 'badge': '近7天', 'abstract': 'Ocean Exploration Trust和NOAA宣布E/V Nautilus将于2026年6月至10月开展太平洋中西部深海探索航季，利用测深声纳、ROV系统和合作方探索技术，调查深海栖息地、地质特征和海洋遗产遗址，并集成新兴探索技术。同时Schmidt Ocean Institute公布2026年全年9个航次计划（1-12月），覆盖南大西洋深海生态系统、亚马逊峡谷浊流研究、加勒比海盐指现象调查及大西洋中脊断裂带生命探索。', 'source': 'NOAA Ocean Exploration / OET / Schmidt Ocean Institute', 'url': 'https://oceanexplorer.noaa.gov/expedition/26nautilus/', 'date': '2026-05-07'},
  ]},
  {'title': '八、海洋数据中心', 'en': 'Ocean Data Centers', 'items': [
    ...
    {'title': 'PANGAEA（2026-05-07/08）：社区研讨会——"从PANGAEA发现和获取数据"实操培训', 'badge': '近7天', 'abstract': 'PANGAEA地球与环境科学数据平台于5月7-8日举行为期两天的社区研讨会（CEST 10:30-12:30），主题为"从PANGAEA发现和获取数据"。课程涵盖系统性数据发现策略、数据获取与Jupyter Notebooks集成工作流、编程工具与标准实践。PANGAEA作为全球最大的地球科学数据仓库之一，拥有数十万条已发布数据集，同时其Event-Campaign Merge数据库架构现代化升级持续推进中。', 'source': 'PANGAEA / AWI / MARUM / de.NBI', 'url': 'https://wiki.pangaea.de/wiki/PANGAEA_Community_Workshops', 'date': '2026-05-07'},
  ]},
  {'title': '九、工具与代码资源', 'en': 'Tools & Code Resources', 'items': [
    {'title': 'Maritime Technology Review（2026-05-05）：Woolpert与Chance Maritime完成NOAA首个全无人近海水文测量——墨西哥湾1391平方海里', 'badge': '近7天', 'abstract': 'Woolpert和Chance Maritime完成NOAA委托的首个全无人近海水文测量任务，在墨西哥湾佛罗里达州彭萨科拉附近完成了1391平方海里的海底测绘。项目使用Chance MC40无人水面艇搭载Woolpert多波束声纳，通过Starlink实时传输数据，接入ASPEN自动测量生产环境系统进行远程后处理。该项目继承2025年混合有人/无人先导试验成果（6000+线性海里），升级为全自主运营，任务量约11000线性海里，为NOAA和合作伙伴开发栖息地地图以支持深水地平线漏油事件后的中光层和深海底栖群落修复。', 'source': 'Maritime Technology Review / Woolpert / Chance Maritime', 'url': 'https://maritimetechnologyreview.com/2026/05/05/woolpert-chance-maritime-redefine-ocean-mapping-with-first-fully-uncrewed-survey/', 'date': '2026-05-05'},
    {'title': 'NOAA（2026-05-06）：NOAA授予2160万美元合同采购Chance LR30无人水面艇——支持新一代测绘船', 'badge': '近7天', 'abstract': 'NOAA宣布向Chance Maritime Technologies授予2160万美元合同，采购最多8套Chance LR30无人水面艇系统。该系统具备直接操控、半自主（碰撞规避+动态航迹跟踪）和全自主三种运行模式，将装备于NOAA新一代测绘船Surveyor和Navigator，用于海底测绘和渔业声学调查。此项投资标志着NOAA海洋测绘向无人化转型的重大战略举措。配套发布的ADT-HURSAT Python Notebook（GitHub:NCEI-NOAAGov/data-tour-notebooks）提供了该数据集的交互式探索和可视化教程。', 'source': 'NOAA / Seapower Magazine / AUVSI', 'url': 'https://seapowermagazine.org/noaa-awards-21-6m-for-uncrewed-systems-to-support-new-charting-and-mapping-vessels/', 'date': '2026-05-06'},
