...
- **09-04（17条，9方向全有）**：合成孔径声呐ATR的CNN/Transformer大规模对比(arXiv 2609.01800, 09-01)、ICE-3D时空多尺度感知学习逐日北极海冰厚度(天津大学, Remote Sensing 18(17) 2991, 09-03)、SHIP-AID浅水沉船隐患GeoAI检测框架(Remote Sensing 18(17) 2884, 08-26)、残差-状态空间混合架构北极海冰分割网络(《中国航海》万方, 08-31)、厦门"文鳐"船舶与海洋工程大模型入选省级优质垂直模型+"海嘉"数字中枢平台首发(福建东南网, 09-04)、Fugro新加坡AI驱动海洋数字孪生获EDB支持(09-03)、北海预报减灾中心"近岸淹没精细化数字孪生"研发外协采购(中国政府采购网, 09-02)、NEODAAS航次卫星海洋观测可视化门户(08-26)、IMOS Live升级新增AusTemp+75岸基波浪浮标(08-27)、迄今最大规模多传感器融合海洋水色叶绿素产品精度评估(Front. Remote Sens. frsen.2026.1825086, 08-26)、注意力增强3D-U-Net++西太平洋三维温盐场重构+1993-2023数据集(中科院海洋所, ESSD 18 4617, 09-04)、BBNJ信息交换机制CHM数据治理基础研究(Front. Mar. Sci. 1840546, 08-31)、EMODnet数据吸纳服务新阶段(08-31)、海南2026下半年共享航次启航+"深海科创积分"闭环(海南日报, 09-04)、上海海洋大学中西印度洋公海渔业调查船租赁落标9月起100站点(中国政府采购网, 08-31)、第十一次国家科学数据中心主任联席会舟山召开(NMDIS, 09-03)、OpenDrift v1.14.12(PyPI, 08-31)。**时效**：0违规(最长9天)。**链接**：17/17有效。**去重**：URL级比对近12期163个URL，0重复；4c关键词grep前置通过。**剔除**：arXiv 2608.30471(HorizonNet)经查为2018旧文arXiv补登；GLODAPv3(ESSD预印本)07-21已收录
- **09-07（15条有效+2方向备注[D2/D3无新增]）**：MHWCorrNet可解释DL订正ECMWF海洋热浪次季节预报全球CSI+9%(JGR:MLC, 南海所, 09-01)、本体+多LLM认知架构AUV共享自主GPT-OSS/Qwen2.5(arXiv 2608.29347, 08-29, 聚合站显示09-01实为08-29 v1)、SurgeGen两阶段扩散风暴潮情景生成(arXiv 2609.03382, 09-03)、EchoST-SSL渔业回声探测自监督时空表征(IEEE Sensors J., 中国水产科学研究院, 09-03)、RFA+RCSA改进YOLO11n轻量化水下海洋垃圾检测4.19M参数(Sustainability su18178986, 09-02)、PhyEnv-GAN船舶运动学+海况船舶行为异常检测(Ocean Eng, 09-01)、S-DEIM稀疏离散经验插值+RNN仅0.2%格点重建SST场(JGR:MLC JH001279, 08-27)、海滩为标尺卫星岸线把近岸潮汐分辨率10km→100m(Comm. Earth & Env., 09-01)、西班牙MITECO+IEO-CSIC 2576万欧元海洋战略协议(09-01)、NSF未来海洋观测优先级公开征集意见截止9/30覆盖OOI/GO-BGC/COSZO/OBISC(OOIFB, 实测09-02, 原标09-01已修正)、MBARI海山热点航次ROV Doc Ricketts 3277米拍大鳍鱿鱼(09-02)、OSIL 3.0米海洋观测浮标安防+海洋学(实测09-03, 原标09-04已修正)、美国BGC-Argo浮标网络资金中断18国阵列半数美方部署(KPBS原始报道, 08-28, 已替换Yahoo/Surfer转载09-03)、EMODnet首次纳入欧洲游艇码头数据50泊位+OSM对齐(EBI, 09-01)、coops-mcp 0.1.1 NOAA CO-OPS潮汐水位海流接MCP(PyPI, 09-04; 同repo erddap-mcp为02-21旧版已规避)。**时效**：0违规(最长11天, S-DEIM 08-27)。**去重**：4c前置grep全NONE。**日期修正3处**：NSF 09-01→09-02、OSIL 09-04→09-03、BGC-Argo Yahoo→KPBS(08-28首发)。**注**：09-05/09-06无产出（会话中断）
- **09-08（13条有效+2方向备注[D3可视化/D4数据质量无新增]，9方向框架）**：NWM神经波浪模型：国际上首个AI+数值模式混合海浪模型全可微分框架10%数据相关系数>0.99(Ocean Eng 366 127556, 中山大学×南信大, 09-06新闻稿)、AquaBEV 3D声呐监督单目水下BEV占用预测31.4/38.6 IoU(arXiv 2609.04411, 09-03)、SEMI-DETR半监督检测34张标注让白鲸幼鲸检出超越监督基线5-10倍降标注(Front. Mar. Sci. 09-04, FAU+DFO)、Too Rare to Learn孟加拉湾海洋模拟器气旋轨迹硬编码反损技巧p=3.1e-5(arXiv 2609.04635, 09-04)、Fugro加入欧盟OCEANITY共建欧洲数字孪生海洋EDITO应用2026-09~2029-08(09-07, 区别于09-04新加坡枢纽)、A-Predator各向异性核点卷积MBES点云配准10%重叠召回31.6%→59.6%(Remote Sensing 18(17) 3035, 西北工大, 09-05)、DenseNet-121跨河口颜色锋识别泛化F1 0.744密西西比0.874珠江0.607(JMSE 14(17) 1657, 中科院地理所, 09-06)、EMODnet生物与海床栖息地CINEA 392万欧元新招标截止10-23(EuroGOOS, 09-03)、雪龙2号冰站无人机远距投放海冰浮标+抗低温磁探无人机原型测试精度3m(新华社, 09-05, 关联09-02期第16次北冰洋科考)、国家极地科学数据中心2026开放课题设极地AI-Ready数据集与模型构建方向4项5万截止09-30(中国极地研究中心, 09-04)、南海海洋大数据智能管理平台130TB/260图层/500万条+AI识别(红树林>90%)+南海孪境数字孪生(《中国测绘》/南海海域海岛中心, 09-04)、Mini-Girona I-AUV开源干预型水下机器人平台(arXiv 2609.02605, 09-02)、Underwater Acoustic Channel Library水声信道开源库(arXiv 2609.03207, 09-02)。**时效**：13条全≤6天0违规。**去重**：25关键词grep仅Fugro/极地中心/AI-Ready/雪龙2命中历史不同事件，新条目全NONE。**院所**：qdio 09-04温盐场实时智能重构=09-04期ESSD同源新闻稿不重复。**发布事故**：deploy首版补丁失败致摘要沿用上期，git checkout恢复后重写修复
