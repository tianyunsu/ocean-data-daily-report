...
- **09-14（16条+1备注[D9暂无新增]）**：KiloDA扩散模型0.24%格点重建公里尺度风场(arXiv 2609.11230, 09-10)、Ocean-E2E混合物理+数据驱动端到端神经同化极端海洋热浪预报(KDD 2026 AI4Science, 清华SAIL+崂山实验室, 08-09)、高频雷达波高窗口包络统计(2609.10920, 09-10)、ML天气预报模型挪威北部站点评估(2609.10564, 挪威科大, 09-11)、扩散先验引导稀疏观测温度降尺度(2609.09247, 印度统计研究所, 09-09)、EMODnet全量数据集实现EDITO数据湖自动化同步(EMODnet Newsletter Summer 2026, 09-01)、WakeAtlas免费CesiumJS三维海洋探索平台(DEV Community/wakeatlas.uk, 09-12)、DTF-Net双轨融合网络无邻站浮标风QC(JMSE 14(16)1453, 北海预报中心, 08-07)、事件保留型海岸浮标温度QC框架AUC 0.987(JMSE 14(16)1462, 韩国NIFS+江原大, 08-08)、MG-GCNN多粒度图神经网络三维海洋环境场重建(RS 18(17)3003, 西北工大, 09-04)、UN海洋十年社会经济数据共享指南(DCO-ODS, EMODnet参与, 09-10)、EMODnet Biology北海底拖网影响数据产品(09-11)、东海秋季共享航次向阳红18(自然资源部一所, 09-10~09-19)、西太平洋热液区联合科考向阳红10(清华+青岛海洋地质所+上海交大, 09-11报道)、雪龙2号为法国塔拉极地站破冰引航110海里(新华社, 9月)、EMODnet数据吸纳服务新阶段CMCC牵头(08-31)。剔除：OceanParcels v3.1.4(2025-08-07 >60天)、Fugro OCEANITY(重复于09-08)、WavyOcean 3.0(07-09 >60天)、Tsinghua DT review(01-2026 >60天)
