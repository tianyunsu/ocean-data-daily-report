...
- **09-07（17条含2条占位，实质15条；另一台机器生成，本机做审查+补记忆）**：MHWCorrNet可解释DL订正ECMWF海洋热浪S2S预报+9%(JGR:MLC/南海海洋所 09-01)、本体+多LLM的AUV共享自主认知架构(arXiv 2608.29347, 08-29)、SurgeGen两阶段扩散合成风暴潮(arXiv 2609.03382, 09-03)、EchoST-SSL渔业回声探测自监督时空表征(IEEE Sensors J./淡水中心, 09-03)、RFA+RCSA改进YOLO11n轻量化水下海洋垃圾检测(Sustainability 18(17)8986, 09-02)、D2/D3暂无新增占位、PhyEnv-GAN融合运动学约束与海况的船舶行为异常检测(Ocean Engineering, 09-01)、S-DEIM 0.2%格点观测重建高分辨率SST(JGR:MLC, 08-27)、卫星岸线时间序列把近岸潮汐分辨率10km→100m(Comm. Earth&Env., 09-01)、西班牙MITECO与IEO-CSIC 2576万欧元海洋科学协议(09-01)、NSF未来海洋观测优先级公开征集截止9/30(OOIFB, 09-01)、MBARI海山热点航次ROV 3277m拍到大鳍鱿鱼(09-02)、OSIL 3.0米海洋观测浮标(09-04)、美国BGC-Argo资金10月中断(★KPBS原始报道08-28，非Yahoo/Surfer)、EMODnet首次纳入欧洲游艇码头数据(EBI, 09-01)、coops-mcp 0.1.1接入NOAA CO-OPS(PyPI, 09-04)。**时效**0违规(最长11天)；**链接**15/15有效(4条403为反爬，WebFetch确认)；**去重**近12期165 URL，0重复。**本机修复**：Yahoo转载链接大陆不可访问→替换为KPBS原始报道，日期改为首发08-28
